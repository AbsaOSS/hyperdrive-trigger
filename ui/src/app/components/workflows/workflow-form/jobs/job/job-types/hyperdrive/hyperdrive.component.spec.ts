...
import { HyperdriveComponent } from './hyperdrive.component';
...
describe('HyperdriveComponent', () => {
  let fixture: ComponentFixture<HyperdriveComponent>;
  let underTest: HyperdriveComponent;
  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        declarations: [HyperdriveComponent],
      }).compileComponents();
    }),
  );

  beforeEach(() => {
    fixture = TestBed.createComponent(HyperdriveComponent);
