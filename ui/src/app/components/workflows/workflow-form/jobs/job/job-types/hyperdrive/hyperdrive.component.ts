...
@Component({
  selector: 'app-hyperdrive',
  templateUrl: './hyperdrive.component.html',
  styleUrls: ['./hyperdrive.component.scss'],
})
export class HyperdriveComponent implements OnInit, OnDestroy {
