...
export class WorkflowsEffects {
  ...
  workflowsInitialize = createEffect(() => {
  ...
  workflowInitializationStart = createEffect(() => {
    return this.actions.pipe(
  ...
  workflowActiveStateSwitch = createEffect(() => {
    return this.actions.pipe(
  ...
  updateWorkflowsIsActive = createEffect(() => {
    return this.actions.pipe(
  ...
  historyForWorkflowLoad = createEffect(() => {
    return this.actions.pipe(
  ...
  workflowsFromHistoryLoad = createEffect(() => {
    return this.actions.pipe(
