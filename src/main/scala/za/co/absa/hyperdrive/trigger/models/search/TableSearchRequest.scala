...
case class TableSearchRequest(
  ...
  containsMultipleFilterAttributes: Option[Seq[ContainsMultipleFilterAttributes]] = None,
  ...
  def getContainsMultipleFilterAttributes: Seq[ContainsMultipleFilterAttributes]= containsMultipleFilterAttributes.getOrElse(Seq())
}
